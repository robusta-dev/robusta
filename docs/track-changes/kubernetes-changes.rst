...
Looking to get push notifications (e.g. Slack or other sinks) when Kubernetes resources change? See the :doc:`K8s Change Notification </playbook-reference/kubernetes-examples/kubernetes-change-notifications>` guide in the Advanced section.
