...
Builtin actions
^^^^^^^^^^^^^^^^^^
.. robusta-action:: playbooks.pod_troubleshooting.python_debugger
...
.. robusta-action:: playbooks.pod_troubleshooting.python_profiler
...
.. robusta-action:: playbooks.pod_troubleshooting.python_memory
