...
.. code:: bash
    ...
    api.robusta.dev,robusta-charts.storage.googleapis.com,ghcr.io,us-central1-docker.pkg.dev,platform.robusta.dev,xvyhpoxfmtpuqqeyqkso.supabase.co,relay.robusta.dev,sp.robusta.dev
