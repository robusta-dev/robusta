...
PROMETHEUS_CLUSTER_LABEL_VALUE = os.environ.get("PROMETHEUS_CLUSTER_LABEL_VALUE")
PROMETHEUS_CLUSTER_LABEL_NAME = os.environ.get("PROMETHEUS_CLUSTER_LABEL_NAME", "cluster")
