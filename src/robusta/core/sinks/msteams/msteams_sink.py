...
class MsTeamsSink(SinkBase):
    def __init__(self, sink_config: MsTeamsSinkConfigWrapper, registry):
        ...
        self.use_emoji = False if (sink_config.ms_teams_sink.use_emoji is None) else sink_config.ms_teams_sink.use_emoji

    def write_finding(self, finding: Finding, platform_enabled: bool):
        MsTeamsSender.send_finding_to_ms_teams(
            self.webhook_url, finding, platform_enabled, self.cluster_name, self.account_id, self.use_emoji
        )
