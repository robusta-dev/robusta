...
from hikaru.model.rel_1_26 import DaemonSet, HorizontalPodAutoscaler, Node, StatefulSet, OwnerReference
...
class PrometheusKubernetesAlert(
    ...
    def get_alert_subject(self) -> FindingSubject:
        ...
        if self.deployment:
            ...
            owner_references = self.deployment.metadata.ownerReferences
        elif self.daemonset:
            ...
            owner_references = self.daemonset.metadata.ownerReferences
            ...
            owner_references = self.statefulset.metadata.ownerReferences
        elif self.node:
            ...
            owner_references = self.node.metadata.ownerReferences
        elif self.pod:
            ...
            owner_references = self.pod.metadata.ownerReferences
        elif self.job:
            ...
            owner_references = self.job.metadata.ownerReferences
        elif self.hpa:
            ...
            owner_references = self.hpa.metadata.ownerReferences
        ...
        return FindingSubject(name, subject_type, namespace, node_name, container, labels, annotations,
                              owner=FindingOwner(owner_references=owner_references, unknown_owner=unknown_owner))
