...
from robusta.core.reporting import Emojis, Finding, FindingSeverity, FindingSource, FindingSubject, FindingSubjectType
    ...
    def get_description(self) -> str:
        ...
        if annotations.get("description"):
            ...
            if annotations.get("runbook_url"):
                runbook_url = f"\n <{annotations.get('runbook_url')}|Runbook{Emojis.Runbook.value}>"
