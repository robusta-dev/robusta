...
from robusta.integrations.kubernetes.autogenerated.v2beta1.models import KIND_TO_MODEL_CLASS as v2beta1
from robusta.integrations.kubernetes.autogenerated.v2beta2.models import KIND_TO_MODEL_CLASS as v2beta2
