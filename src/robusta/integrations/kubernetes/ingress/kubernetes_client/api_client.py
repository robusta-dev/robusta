...
import src.robusta.integrations.kubernetes.ingress.kubernetes_client.ingress_models
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(src.robusta.integrations.kubernetes.ingress.kubernetes_client.ingress_models, klass)
